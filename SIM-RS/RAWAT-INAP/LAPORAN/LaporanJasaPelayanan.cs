...
namespace SIM_RS.RAWAT_INAP
{
    public partial class LaporanJasaPelayanan : Form
    {
        ...
        private void bgWorkLoadFromDB_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            /* QUERY ASKESGAKIN*/
            this.strQuerySQL = " SELECT  BL_TRANSAKSI.Regbilling, MR_PASIEN.Nama, MR_TRUANGAN.ruangan, "+
                                  " BL_TRANSAKSI.Jumlah, BL_TRANSAKSI.subsidi, BL_TRANSAKSI.tunai, "+
                                  " BL_TRANSAKSIDETAIL.Idbl_komponen, BL_TRANSAKSIDETAIL.Nilai, "+
                                  " BL_TRANSAKSIDETAIL.Ringan, BL_KELTARIP.urutan, BL_KELTARIP.rekapjp,"+
                                  " BL_TRANSAKSIDETAIL.Nilai - BL_TRANSAKSIDETAIL.Ringan as tunainya , "+
                                  " BL_TRANSAKSIDETAIL.Noambil,BL_TRANSAKSIDETAIL.tglambil, "+
                                  " BL_KELTARIP.Idbl_keltarip, BL_KELTARIP.Lapjp, BL_TRANSAKSI.idmr_tsmf, "+
                                  " MR_SMFTARIP.idmr_tupf, BL_TRANSAKSI.idbl_tarip, BL_TRANSAKSI.uraiantarip, "+
                                  " BL_TRANSAKSI.jml_kasus_tarip, BL_TRANSAKSI.idbl_transaksi, "+
                                  " BL_KASASKES.Idbl_Pembayaran, BL_TRANSAKSI.Tgltransaksi, BL_KASASKES.Tanggal, "+
                                  " BL_TARIP.Idmr_jeniskelas, BL_TRANSAKSI.Idmr_truangan, "+
